  ...
  class ProductNewAttribute < Mage::Base
    ...
    def find_attribute(attribute_code)
      ...
      if attribute.nil?
        ...
        :attribute_model => nil,  
        :backend_model => '',    
        :backend_type => att[:is_selectable].checked? ? 'int' : 'varchar',
        :backend_table => '',
        :frontend_model => '', 
        ...
        cea = CatalogEavAttribute.new(
          ...
          :is_global => 1,
          :is_visible => att[:is_visible].checked?, 
          :is_searchable => att[:is_searchable].checked?, 
          :is_filterable => att[:is_filterable].checked?,
          :is_comparable => att[:is_comparable].checked?, 
          :is_visible_on_front => 1,
          :is_html_allowed_on_front => 1, 
          :is_used_for_price_rules => 1,
          :is_filterable_in_search => 1,
          :used_in_product_listing => 1,
          :used_for_sort_by => att[:used_for_sort_by].checked?,
          :is_configurable => 1,
          :apply_to => '',
